...
#include "getsensoractiveinfos_fuzzer.h"
...
void GetSensorActiveInfosFuzzTest(const uint8_t* data, size_t size)
{
...
{
    OHOS::Sensors::GetSensorActiveInfosFuzzTest(data, size);
    return 0;
}
