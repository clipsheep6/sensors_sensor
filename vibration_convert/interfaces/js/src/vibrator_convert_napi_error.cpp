...
namespace Sensors {
namespace {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL { LOG_CORE, SENSOR_LOG_DOMAIN, "VibratorConvertNapiError" };
const std::map<int32_t, std::string> ERROR_MESSAGES {
    { PERMISSION_DENIED, "Permission denied." },
    { PARAMETER_ERROR, "The parameter invalid." },
    { SERVICE_EXCEPTION, "Use this error code when the service is exception." },
};
}  // namespace
