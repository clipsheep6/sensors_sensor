...
public:
    ...
    static napi_value AudioToHaptic(napi_env env, napi_callback_info info);
    static napi_value JsVibratorConvert(napi_env env, napi_callback_info info);
...
private:
    ...
    static bool ParseAudioSetting(napi_env env, napi_value &value, AudioSetting &audioSetting);
